...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/community-health/StructureDefinition/probability']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/community-health/StructureDefinition/probability': maximum cardinality of 'extension' is 1</sch:assert>
